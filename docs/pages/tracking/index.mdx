...
Tracking in Sajari can give you insights into the search behavior of your users and how your content is performing. Tracking data is also fed back into Sajari's AI model to improve search ranking over time.
...
Sajari's website search uses ClickTracking by default while our Shopify search solution uses PosNegTracking by default.
