...
First, we submit any pending positive tokens associated with result clicks from the previous screen. This submit lets the Sajari engine know that this was likely a good result for the search term.
