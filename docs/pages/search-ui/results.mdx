  ...
  <article class="relative p-3 rounded-md border border-gray-200 shadow flex flex-col h-full">
     <div>
       <div class="relative">
         <div class="product-image">
           <img data-search-first-image class="absolute top-0 left-0 h-full w-full object-contain object-center" src="{{image}}" />
         </div>
       </div>
       <div data-search-product-images-container></div>
     </div>
     ...
     <div class="flex flex-col mt-auto">
       ...
       <div class="flex justify-between">
         ...
         {{#if free_shipping}}
         <div class="flex flex-shrink-0 rounded px-1 items-center text-xs text-green-500 border border-green-500 bg-green-200">
         ...
         {{#else}}
         <div class="flex flex-shrink-0 rounded px-1 items-center text-xs text-red-500 border border-red-500 bg-red-200">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
