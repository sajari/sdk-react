...
| `multi`        | `boolean`                                |                                   | List of items to be included from the filter options.                                                                                       |
| `includes`     | `string[]`                               |                                   | List of items to be excluded from the filter options.                                                                                       |
| `excludes`     | `string[]`                               |                                   | Only include the filter options that starts with the prefix.                                                                                |
| `prefixFilter` | `string`                                 |                                   | Multiple selections allowed.                                                                                                                |
