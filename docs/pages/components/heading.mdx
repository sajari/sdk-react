...
<SEO title="Heading" description="Heading are used for rendering headlines. It renders an <h1> element by default." />

# Heading

Headings are used for rendering headlines. It renders an `<h1>` element by default.
