...
If you still want to use the pre-built components, you'll want to use the [`@sajari/react-search-ui`](https://www.npmjs.com/package/@sajari/react-search-ui]) package, which has the following differences from v2 of the React SDK:
