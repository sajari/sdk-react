...
This package also depends on [`react`](https://www.npmjs.com/package/react).
Please make sure you have that installed as well.

## Quick start

- See the [quick start](/quick-start) guide to setup a basic search.
