...
export const InputWrapper: React.SFC<InputWrapperProps> = ({ children, style, theme }) => {
  let pipeline = new Pipeline({ project: 'sajariptyltd', collection: 'sajari-com' }, 'website');
